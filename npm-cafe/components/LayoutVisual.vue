<template>
    ...
    >
        <div
            :class="`absolute top-0 w-full h-full bg-center bg-cover ${visual}`"
        >
            <span
                id="blackOverlay"
        ...
        <div class="container relative mx-auto">
            <div class="items-center flex flex-wrap">
                <div class="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                    <div>
                        <h1
                            class="text-white font-semibold text-5xl text-shadow"
                        >
                            {{ title }}
                        </h1>
                        <p
...
<style scoped>
.visual-home {
    background-image: url('~@/assets/リネーム/visual-home.jpg');
}
.visual-concept {
    background-image: url('~@/assets/リネーム/ogasuta458A8143_TP_V.jpg');
}
.visual-shop {
